...
(
    ...
    CONSTRAINT FK_STUDY_CATEGORY_LANG FOREIGN KEY(CATEGORY_LANG_NO) REFERENCES CATEGORY_LANG_TABLE(CATEGORY_LANG_NO),
    CONSTRAINT FK_STUDY_CATEGORY_TYPE FOREIGN KEY(CATEGORY_TYPE_NO) REFERENCES CATEGORY_TYPE_TABLE(CATEGORY_TYPE_NO),
